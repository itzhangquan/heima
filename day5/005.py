...
def index():
    ...
    if request.method == "GET":
        ...
        if msg_type == "text":  # 文本消息
            ...
            return text_message(dict_data)

        elif msg_type == "voice":  # 语音消息

           return voice_message(dict_data)
        elif msg_type=="event":
            return notice_message(dict_data)


        else: # 其他类型消息
            return other_message(dict_data)# 封装返回的字典

def text_message(dict_data):
    resp_dict = {
